...
EntityPlayertall = ig.Entity.extend({
  ...
  offset: {x: 34, y: 34},
	...
	animSheet: new ig.AnimationSheet( 'media/playertall.png', 150, 200 ),	
  ...
  selected: false,
	...
	init: function( x, y, settings ) {
		...
		this.addAnim( 'run', 0.15, [6,7,8,9,10] );
		this.addAnim( 'jump', 0.1, [1,2], true );
		this.addAnim( 'fall', 0.4, [4], true ); // stop at the last frame
		this.addAnim( 'ground', 0.1, [5,6], true ); // stop at the last frame
