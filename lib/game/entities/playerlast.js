...
EntityPlayerlast = ig.Entity.extend({
  ...
  offset: {x: 55, y: 90},
	...
	animSheet: new ig.AnimationSheet( 'media/playerlast.png', 200, 400 ),	
  ...
  selected: false,
	...
	init: function( x, y, settings ) {
		...
		this.addAnim( 'run', 0.15, [1,2,3,4,5] );
		this.addAnim( 'jump', 0.1, [6,7,8], true );
		this.addAnim( 'fall', 0.4, [8], true ); // stop at the last frame
		this.addAnim( 'ground', 0.1, [9,10,0], true ); // stop at the last frame
