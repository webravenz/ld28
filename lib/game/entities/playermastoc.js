...
EntityPlayermastoc = ig.Entity.extend({
  ...
  offset: {x: 50, y: 72},
	...
	animSheet: new ig.AnimationSheet( 'media/playermastoc.png', 250, 250 ),	
  ...
  selected: false,
	...
	init: function( x, y, settings ) {
		...
		this.addAnim( 'run', 0.1, [1,2,3,4,5,6,7,8] );
		this.addAnim( 'jump', 0.05, [1,2,5], true );
		this.addAnim( 'fall', 0.15, [9,10], true ); // stop at the last frame
		this.addAnim( 'ground', 0.15, [11,12,0], true ); // stop at the last frame
